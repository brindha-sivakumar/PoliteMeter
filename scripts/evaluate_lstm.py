...
def main():
    ...
    try:
        model = PolitenessClassifierLSTM.load_model('models/lstm_model.pkl')
    except FileNotFoundError:
        print("❌ Model not found! Train the model first using train_lstm.py")
        return
    ...
    axes[1].set_title('LSTM Per-Class Accuracy')
    axes[1].set_ylim([0, 1])
    ...
    plt.tight_layout()
    plt.savefig('results/lstm_evaluation.png', dpi=150, bbox_inches='tight')
    print("✅ Visualization saved to results/lstm_evaluation.png")
    plt.show()
